...
/*public class Taker extends User {
    ...
    public Taker(int userId, String fName, String lName, String tel, Address address, Account account, int idCard) {
        super(userId, fName, lName, tel, address, account);
        this.idCard = idCard;
    }

    public Taker(User user, int idCard) {
        super(user.getUserId(), user.getfName(), user.getlName(), user.getTel(), user.getAddress(), user.getAccount());
        this.idCard = idCard;
    }
...
// public class Taker extends User {
//     private int idCard;
//     Taker(int userId, String fName, String lName, String tel, Address address, Account acc, int idCard) {
