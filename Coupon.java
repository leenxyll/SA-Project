...
public class Coupon {
    ...
    private Coupon(int coupon_id,String coupon_name,String coupon_description,String coupon_type,LocalDateTime coupon_startDate,LocalDateTime coupon_endDate, int  coupon_taked){
    ...
    public Coupon findCoupon(int couponId){
        for(Coupon aCpns : cpns){
            if(couponId == aCpns.getCoupon_id() && aCpns.coupon_taked != 0) return aCpns;
        }
        return null;
    }

    private static void getCoupon(){
       cpns.add(new Coupon(1, "van jj", "jj laijai", "Fashion",LocalDateTime.of(2022, 03,11, 12, 2, 2),LocalDateTime.of(2022, 03,21, 12, 2, 2),10));
       cpns.add(new Coupon(2, "a", "aa", "Fashion",LocalDateTime.of(2022, 06,11, 12, 2, 2),LocalDateTime.of(2022, 06,21, 12, 2, 2),5));
       cpns.add(new Coupon(3, "b", "bbi", "Food",LocalDateTime.of(2022, 04,11, 12, 2, 2),LocalDateTime.of(2022, 04,21, 12, 2, 2),7));
       cpns.add(new Coupon(4, "c", "cc", "Food",LocalDateTime.of(2022, 07,11, 12, 2, 2),LocalDateTime.of(2022, 07,21, 12, 2, 21),7));
       cpns.add(new Coupon(5, "d", "dd", "Fashion",LocalDateTime.of(2022, 03,11, 12, 2, 2),LocalDateTime.of(2022, 03,21, 12, 2, 2),0));
    }
    ...
    // private void add_coupon(int coupon_id,String coupon_name,String coupon_description,String coupon_type,LocalDateTime coupon_startDate,LocalDateTime coupon_endDate){
    ...
    public String toString() {
        return coupon_id + " : " + coupon_name + "\t( " + coupon_description + " ) " + "\tStart : " + coupon_startDate + "\tEnd : " + coupon_endDate + "\t qty : " + coupon_taked;
    }
