...
class Product{
    ...
    private Product(int product_id, String product_name, double product_price, String detail_product,  String product_type, int product_disPrice, LocalDateTime product_startDate,LocalDateTime product_endDate,int product_ordered){
    ...
    public Product findProduct(int product_id){
        for(Product aProduct : pdts){
            if(product_id == aProduct.getProduct_id()) return aProduct;
        }
        return null;
    }

    private static void getproduct(){
       pdts.add(new Product(0, "a", 1500, "aa", "Fashion", 999, LocalDateTime.of(2022, 03,11, 12, 2, 2),LocalDateTime.of(2022, 03,21, 12, 2, 2),0));
       pdts.add(new Product(1, "b", 1500, "bb", "Fashion", 999, LocalDateTime.of(2022, 03,11, 12, 2, 2),LocalDateTime.of(2022, 03,21, 12, 2, 2),0));
       pdts.add(new Product(2, "c", 1500, "cc", "Tech", 999, LocalDateTime.of(2022, 03,11, 12, 2, 2),LocalDateTime.of(2022, 03,21, 12, 2, 2),0));
       pdts.add(new Product(3, "d", 1500, "dd", "Home", 999, LocalDateTime.of(2022, 03,11, 12, 2, 2),LocalDateTime.of(2022, 03,21, 12, 2, 2),0));
       pdts.add(new Product(4, "e", 1500, "ee", "Fashion", 999, LocalDateTime.of(2022, 03,11, 12, 2, 2),LocalDateTime.of(2022, 03,21, 12, 2, 2),0));
    }


    public Product add_Product( int product_id){
       for(Product apdts : pdts){
           if(apdts.product_id == product_id){
     ...
     public Product select_Product( int product_id){
        for(Product apdts : pdts){
            if(apdts.product_id == product_id){ 
                return apdts;
            }
    ...
    public String toString() {
        return product_id + " : " + product_name + "\t ( " + detail_product + " ) " + "\tPrice : " + product_price + "\tDiscount : " + product_disPrice + "\tStart : " + product_startDate + "\tEnd : " + product_endDate;
    }
}